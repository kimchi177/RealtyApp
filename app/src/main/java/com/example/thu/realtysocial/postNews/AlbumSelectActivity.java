...
import com.example.thu.realtysocial.postNews.adapters.CustomAlbumSelectAdapter;
import com.example.thu.realtysocial.postNews.model.Album;
...
public class AlbumSelectActivity extends HelperActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       com.example.thu.realtysocial.postNews.Constants.limit = intent.getIntExtra(Constants.INTENT_EXTRA_LIMIT, Constants.DEFAULT_LIMIT);
        ...
        gridView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                intent.putExtra(com.example.thu.realtysocial.postNews.Constants.INTENT_EXTRA_ALBUM, albums.get(position).name);
                startActivityForResult(intent, com.example.thu.realtysocial.postNews.Constants.REQUEST_CODE);
            }
        });
    }
    ...
    protected void onStart() {
        ...
        handler = new Handler() {
            ...
            public void handleMessage(Message msg) {
                switch (msg.what) {
                    case com.example.thu.realtysocial.postNews.Constants.PERMISSION_GRANTED: {
                        loadAlbums();
                        break;
                    }
