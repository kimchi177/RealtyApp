...
//    }
    ...
    protected void checkPermission() {
        if (ContextCompat.checkSelfPermission(this,
            ...
            ActivityCompat.requestPermissions(this, permissions, com.example.thu.realtysocial.postNews.Constants.PERMISSION_REQUEST_CODE);
        }
    }
                ...
                .setAction(getString(R.string.permission_ok), new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ActivityCompat.requestPermissions(
                                HelperActivity.this,
                                permissions,
                                com.example.thu.realtysocial.postNews.Constants.PERMISSION_REQUEST_CODE);
                    }
                });
        ...
        Snackbar snackbar = Snackbar.make(
                ...
                .setAction(getString(R.string.permission_settings), new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        intent.setData(uri);
                        startActivityForResult(intent, com.example.thu.realtysocial.postNews.Constants.PERMISSION_REQUEST_CODE);
                    }
                });
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        ...
        if (requestCode != com.example.thu.realtysocial.postNews.Constants.PERMISSION_REQUEST_CODE
