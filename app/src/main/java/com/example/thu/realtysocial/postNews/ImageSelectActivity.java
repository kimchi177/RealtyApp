...
import com.example.thu.realtysocial.postNews.adapters.CustomImageSelectAdapter;
import com.example.thu.realtysocial.postNews.model.Image;
import com.example.thu.realtysocial.postNews.Constants;
...
public class ImageSelectActivity extends HelperActivity {
        ...
        handler = new Handler() {
            ...
            public void handleMessage(Message msg) {
                switch (msg.what) {
                    ...
                    case com.example.thu.realtysocial.postNews.Constants.ERROR: {
                        progressBar.setVisibility(View.INVISIBLE);
    ...
    private class ImageLoaderRunnable implements Runnable {
        ...
        public void run() {
            ...
            if (cursor == null) {
                sendMessage(com.example.thu.realtysocial.postNews.Constants.ERROR);
                return;
            }
